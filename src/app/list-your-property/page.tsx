    ...
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      {step === 1 && (
        <div className="grid gap-3">
          ...
          <input
            className="border rounded px-2 py-2"
            placeholder="Property Type (Residential, Commercial, Estate…)"
      ...
      {step === 2 && (
        <div className="grid gap-3">
          ...
          {/* IMPORTANT: generic <OurFileRouter> fixes the UploadThing v7 typing */}
          <UploadButton<OurFileRouter, "locationPhotos">
            endpoint="locationPhotos"
            onClientUploadComplete={(res) =>
              set(
                "photoUrls",
                [...form.photoUrls, ...res.map((r: any) => r.url)]
              )
            }
          ...
          <div className="flex gap-2">
            <button className="border rounded px-4 py-2" onClick={() => setStep(1)}>
              Back
            </button>
            <button
              className="bg-black text-white rounded px-4 py-2"
      ...
      {step === 3 && (
        <div className="grid gap-3">
          ...
          />
          <div className="flex gap-2">
            <button className="border rounded px-4 py-2" onClick={() => setStep(2)}>
              Back
            </button>
